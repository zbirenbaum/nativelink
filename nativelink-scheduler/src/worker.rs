...
use nativelink_proto::com::github::trace_machina::nativelink::remote_execution::{
    update_for_worker, ConnectionResult, StartExecute, UpdateForWorker, ActionKillRequest,
};
...
impl Worker {
    ...
    pub fn send_kill_action_request(&mut self, unique_qualifier: &ActionInfoHashKey) -> Result<(), Error> {
        send_msg_to_worker(
            &mut self.tx,
            update_for_worker::Update::ActionKillRequest(ActionKillRequest {
